...
exports.RestaurantModule = RestaurantModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([Restaurant_1.Restaurant])],
        providers: [restaurant_resolver_1.RestaurantResolver, restaurant_service_1.RestaurantService],
    })
], RestaurantModule);
